...
const ContactUsForm = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await fetch("http://localhost:8080/addcontacts", {
        method: "POST",
        ...
        <div className="px-4 xl:mt-[5rem] lg:mb-0 mb-[2rem] mt-[3rem]">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div>
              ...
              >
                <option value="I am Writing about">I am Writing about*</option>
            ...
            <div>
              ...
              >
                <option value="Relationship with Jooneli">Relationship with Jooneli*</option>
