    ...
    <div className="">
      ...
      <div className="bg-rose-950 ">
        <div className=" max-w-[1600px] mx-auto">
          <div className="xl:mx-[10rem] lg:mx-[3rem] md:mx-[2.5rem] mx-[4px] flex items-center justify-between py-2 pr-2 md:pl-0 pl-2 text-white ">
          ...
          <div className="flex items-center justify-between xl:mr-[15rem] lg:mr-[11rem] md:mr-[10rem]">
            ...
            <div
              className={` md:hidden  flex justify-center items-center ${
                openBar ? "absolute top-[25px] right-0" : ""
              }`}
            >
              {openBar ? (
                <FaTimes
